...
public sealed class DatabaseSeedingService : BackgroundService
{
    ...
    /// </summary>
    private static async Task CreateSchemaIfNeededAsync(ApplicationDbContext db, CancellationToken ct)
    {
        // Test connectivity first — throws immediately if connection string is wrong
        await db.Database.ExecuteSqlRawAsync("SELECT 1", ct);

        // Use EF's CanConnectAsync to verify then let EF create what's missing
        // via a migration-less approach: open a raw connection and create tables.
        await db.Database.ExecuteSqlRawAsync(@"
            ...
            CREATE TABLE IF NOT EXISTS ""Currencies"" (
                ...
                ""IsActive"" boolean NOT NULL DEFAULT true,
                ""CreatedAt"" timestamptz NOT NULL DEFAULT NOW(),
                ""CreatedBy"" uuid, ""ModifiedAt"" timestamptz, ""ModifiedBy"" uuid,
                ""IsDeleted"" boolean NOT NULL DEFAULT false,
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS ""IX_Accounts_Code"" ON ""Accounts""(""Code"");
            ...
            CREATE TABLE IF NOT EXISTS ""JournalEntries"" (
                ""Id"" uuid NOT NULL DEFAULT gen_random_uuid(),
                ""EntryNumber"" varchar(30) NOT NULL DEFAULT '',
                ...
                ""PostedAt"" timestamptz, ""PostedBy"" uuid,
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS ""IX_JournalEntries_EntryNumber"" ON ""JournalEntries""(""EntryNumber"");
            ...
            -- Operational: Warehouses + Products
            ...
            CREATE UNIQUE INDEX IF NOT EXISTS ""IX_InventoryBalances_ProductId_WarehouseId""
                ON ""InventoryBalances""(""ProductId"", ""WarehouseId"");
            ...
            CREATE TABLE IF NOT EXISTS ""PurchaseReceipts"" (
                ""Id"" uuid NOT NULL DEFAULT gen_random_uuid(),
                ""ReceiptNumber"" varchar(30) NOT NULL DEFAULT '',
                ""PurchaseOrderId"" uuid NOT NULL,
                ""SupplierId"" uuid NOT NULL,
                ""WarehouseId"" uuid NOT NULL,
            ...
            CREATE TABLE IF NOT EXISTS ""SalesOrders"" (
                ""Id"" uuid NOT NULL DEFAULT gen_random_uuid(),
                ""SONumber"" varchar(30) NOT NULL DEFAULT '',
            ...
            CREATE TABLE IF NOT EXISTS ""SalesDeliveries"" (
                ""Id"" uuid NOT NULL DEFAULT gen_random_uuid(),
                ""DeliveryNumber"" varchar(30) NOT NULL DEFAULT '',
                ""SalesOrderId"" uuid NOT NULL,
                ""CustomerId"" uuid NOT NULL,
                ""WarehouseId"" uuid NOT NULL,
            ...
            -- Cheques + Payments + Commissions
            CREATE TABLE IF NOT EXISTS ""Cheques"" (
                ""Id"" uuid NOT NULL DEFAULT gen_random_uuid(),
                ""ChequeNumber"" varchar(50) NOT NULL DEFAULT '',
                ""CustomerId"" uuid NOT NULL,
            ...
            CREATE TABLE IF NOT EXISTS ""CustomerPayments"" (
                ""Id"" uuid NOT NULL DEFAULT gen_random_uuid(),
                ""PaymentNumber"" varchar(30) NOT NULL DEFAULT '',
                ""CustomerId"" uuid NOT NULL,
            ...
            CREATE TABLE IF NOT EXISTS ""BankTransactions"" (
                ""Id"" uuid NOT NULL DEFAULT gen_random_uuid(),
                ""TransactionNumber"" varchar(30) NOT NULL DEFAULT '',
