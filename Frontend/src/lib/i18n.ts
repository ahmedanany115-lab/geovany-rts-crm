...
export const translations = {
  ...
  new_quotation:      { en: "New Quotation",      ar: "عرض سعر جديد" },
  convert_to_order:   { en: "Convert to Order",  ar: "تحويل إلى أمر" },
  ...
  maintenance_contracts:{ en: "Service Contracts",    ar: "عقود الخدمة" },
  maintenance_visits:   { en: "Visits",               ar: "الزيارات" },
  maintenance_equipment:{ en: "Equipment",            ar: "المعدات" },
  contract_number:      { en: "Contract #",           ar: "رقم العقد" },
  visits_per_quarter:   { en: "Visits / Quarter",     ar: "زيارات / ربع سنة" },
  ...
  extra_charges:        { en: "Extra Charges",        ar: "رسوم إضافية" },
  serial_number:        { en: "Serial #",             ar: "الرقم التسلسلي" },
  brand:                { en: "Brand",                ar: "العلامة التجارية" },
  model:                { en: "Model",                ar: "الموديل" },
  quarter:              { en: "Quarter",              ar: "ربع السنة" },
  remaining_visits:     { en: "Remaining Visits",     ar: "الزيارات المتبقية" },
  schedule_visit:       { en: "Schedule Visit",       ar: "جدولة زيارة" },
  complete_visit:       { en: "Complete Visit",       ar: "إتمام الزيارة" },
  work_description:     { en: "Work Done",            ar: "العمل المنجز" },
  add_equipment:        { en: "Add Equipment",        ar: "إضافة معدات" },
} as const;
